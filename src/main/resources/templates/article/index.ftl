                ...
                <#if article.author?? && user??>
                    <#if article.author.username == user.username || user.role?contains("ADMIN")>
                        ...
                        <p><a class="btn btn-success" href="/article/edit/${article.id}">Edit</a> <a href="#"
                                                                                                     ...
                                                                                                     onclick="$('#form_delete_${article.id}').submit();">Delete</a>
                        </p>
                    </#if>
                </#if>
                ...
                <ul class="pagination">
                    <#if articles.hasPrevious()>
                        <li class="page-item"><a class="page-link"
                                                 href="/article?page=${articles.previousPageable().pageNumber}&size=20">Previous</a>
                        </li>
                    </#if>
                    ...
                    <#if articles.hasNext()>
                        <li class="page-item"><a class="page-link"
                                                 href="/article?page=${articles.nextPageable().pageNumber}&size=20">Next</a>
                        </li>
                    </#if>
                </ul>
            </nav>
